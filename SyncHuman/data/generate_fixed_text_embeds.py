...
def generate_mv_embeds():
    path = './fixed_prompt_embeds_7view'
    os.makedirs(path, exist_ok=True)
    views = ["front", "front_right", "right", "back", "left", "front_left", 'face']
    clr_prompt = [f"a rendering image of 3D human, {view} view, color map." for view in views]
    normal_prompt = [f"a rendering image of 3D human, {view} view, normal map." for view in views]
